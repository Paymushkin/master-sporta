...
<template>
    <Teleport to="body">
        ...
        >
            <button type="button" class="absolute inset-0 bg-navy-950/60" aria-label="Закрыть окно" @click="emit('close')" />
            <div class="relative w-full max-w-md rounded-lg bg-white p-6 shadow-card">
                ...
                <p class="label text-blue-600">Кабинет</p>
                <h2 id="login-title" class="font-display mt-3 text-3xl uppercase">Войти в платформу</h2>
                <p class="mt-3 text-gray-600">
                    Авторизация появится на следующем этапе. Сейчас это демонстрация входа в систему.
                </p>
                <div class="mt-6">
